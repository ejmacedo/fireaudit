...
class GetFirewallVpnTunnels:
    ...
    async def execute(self, request: GetFirewallVpnTunnelsRequest) -> list[dict]:
        ...
        if snapshot is None:
            return []
        return snapshot.raw_payload.get("vpn_tunnels", []) or []
