...
- **O agente é o cliente mais crítico de versionar com cuidado:** diferente de um cliente de API tradicional (que um desenvolvedor externo atualiza no próprio ritmo), o agente do FireAudit